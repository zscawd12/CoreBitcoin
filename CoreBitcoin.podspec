Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/zscawd12/CoreBitcoin"
  s.license      = 'WTFPL'
  s.author       = { "Oleg Andreev" => "oleganza@gmail.com" }
  s.ios.deployment_target = '7.0'
  s.osx.deployment_target = '10.9'
  s.source       = { :git => "https://github.com/zscawd12/CoreBitcoin.git", :tag => s.version.to_s }
  ...
  s.dependency 'OpenSSL-Universal', '1.0.2.11'
